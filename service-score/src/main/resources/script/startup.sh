...
-Dskywalking.agent.service_name=service-score \
-Dskywalking.agent.instance_name=service-score-01 \
...
-server -jar ./service-score/build/libs/service-score-1.0-SNAPSHOT.jar